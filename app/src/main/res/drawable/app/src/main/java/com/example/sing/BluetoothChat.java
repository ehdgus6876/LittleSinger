...
// Name of the connected device
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContent = (TextView)findViewById(R.id.in);

        Button scan = (Button)findViewById(R.id.scan);
        scan.setOnClickListener(new View.OnClickListener() { //DeviceList로 이동 (다른기기 찾기)
            @Override
        ...
        find.setOnClickListener(new View.OnClickListener() { //scanning할 수 있게 허락
            @Override
            public void onClick(View v) {
                ensureDiscoverable();
            }
        ...
        // 장비가 소유하고 있는 블루투스 어댑터에 대한 bluetoothadapter 객체 반환
        // 전체 시스템에서 하나만 존재, null 이면 블루투스 지원하지 않는 기기
    ...
    public void onStart() {
        ...
        // 블루투스 활성화 상태인지 확인 가능하다
        // 활성화상태로 변경하기 위해 액션인텐트와 start~() 호출
