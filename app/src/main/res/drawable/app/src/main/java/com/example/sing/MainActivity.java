...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btn1 = findViewById(R.id.btn1); //연습모드
        ...
        ImageButton btn2=findViewById(R.id.btn2); //촬영모드
        ...
        ImageButton btn3=findViewById(R.id.btn3); //듀엣모드
        ...
        ImageButton btn4=findViewById(R.id.btn4); //점수보기
